...
const HomePage = () => {
    ...
    <div>
    <div class="header">
        <nav class="w-auto bg-white border-gray-200 dark:bg-gray-900 text-[20px]">
          <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="https://flowbite.com/" class="flex items-center">
              <img src="https://res.cloudinary.com/dwp7umncy/image/upload/v1680975890/ass_ts_nodejs/logo_TH_hkjdcr.png"
                class="h-8 mr-3" alt="Flowbite Logo" />
              <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">TmHieu</span>
            </a>
